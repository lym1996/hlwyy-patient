    ...
    <div class="modalWrap">
      ...
      <main v-show="!isSuccess">
        ...
        <section v-show="tabIndex === 1">
          <p :class="['flex-align', `${tip.text ? 'margintop15' : 'margintop30'}`]">
            <span
              :class="`${isAgree ? 'theicon-checkbox-checked' : 'agreeCheckbox'}`"
              @click="isAgree = !isAgree"
            ></span>
            <router-link to="/loginCenter" target="_blank">
              <el-button
                type="text"
                class="marginleft10 fontsize-2 color-333 cursorPointer underline"
              >我同意《互联网医院用户协议》</el-button>
            </router-link>
          </p>
